...
// White Pawn
export const WhitePawn: React.FC<SvgPieceProps> = ({ size }) => (
...
// White Knight
export const WhiteKnight: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
...
// White Bishop
export const WhiteBishop: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
// White Rook
export const WhiteRook: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
...
// White Queen
export const WhiteQueen: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="#fff" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
// White King
export const WhiteKing: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
// Black Pawn
export const BlackPawn: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <Path
      stroke="#000"
      strokeLinecap="round"
...
// Black Knight
export const BlackKnight: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
// Black Bishop
export const BlackBishop: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
// Black Rook
export const BlackRook: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
...
// Black Queen
export const BlackQueen: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
      <G stroke="none">
...
// Black King
export const BlackKing: React.FC<SvgPieceProps> = ({ size }) => (
  <Svg width={size} height={size} viewBox="0 0 45 45">
    <G fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
const PIECE_COMPONENTS: Record<PieceSymbol, React.FC<SvgPieceProps>> = {
  P: WhitePawn,
  N: WhiteKnight,
  B: WhiteBishop,
  R: WhiteRook,
...
export const renderCburnettPiece = (piece: PieceSymbol, size: number): React.ReactElement => {
